...
Два фактора — низкие требования к ресурсам и простота использования — делают облегченные дистрибутивы Kubernetes отличным выбором для людей, которые плохо знакомы с Kubernetes и хотят настроить среду на своем собственном компьютере, где они могут экспериментировать с управлением узлами, развертыванием модулей и скоро.
